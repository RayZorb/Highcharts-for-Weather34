...
Max Recorded <br><blue><?php echo $weather["windamaxtime"];?></blue></div>
 ...
 <main class="grid1">
  ...
  <iframe  src="mbcharts/highcharts.php?chart='windsmallplot'&span='yearly'&temp='<?php echo $weather['temp_units'];?>'&pressure='<?php echo $weather['barometer_units'];?>'&wind='<?php echo $weather['wind_units'];?>'&rain='<?php echo $weather['rain_units']?>" frameborder="0" scrolling="no" width="100%" height="210px"></iframe>
