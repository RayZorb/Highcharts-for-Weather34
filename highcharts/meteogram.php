...
<div id="container" style="max-width: 800px; min-width: 380px; height: 435px; margin: 0 auto; border:0px solid rgba(153,153,153,1);border-radius:0px;font-size: 12px;color:#fff;">
...
<div style="width: 800px; margin: 0 auto">
  <a href="#http://www.yr.no/place/United_Kingdom/England/Buckingham/forecast_hour_by_hour.xml">Steeple Claydon</a>,
...
Meteogram.prototype.getTitle = function () {
    return 'Meteogram for Steeple Claydon, United Kingdom';
};
...
var place,
    url;
if (!location.hash) {
    place = 'United_Kingdom/England/Buckingham';
...
$.ajax({
    dataType: 'xml',
    url: url === 'https://www.yr.no/place/United_Kingdom/England/Buckingham/forecast_hour_by_hour.html' ?
