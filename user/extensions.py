...
schema_extended = schemas.wview.schema + [('uva', 'REAL'),('uvb', 'REAL'),('uvawm', 'REAL'),('uvbwm', 'REAL'),('avg_distance', 'REAL'),('lightning_strikes', 'REAL'),('energy', 'REAL'), ('full_spectrum', 'REAL'),('lux', 'REAL'),('infrared', 'REAL')]
import weewx.units
...
weewx.units.obs_group_dict['lux'] = 'group_uv'
