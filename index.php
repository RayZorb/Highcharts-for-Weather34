...
<a alt="yearly wind chill" title="yearly winchill" href="<?php echo $chartsource;?>/<?php echo $theme1;?>-charts.html?chart='windchillplot'&span='yearly'&temp='<?php echo $weather['temp_units'];?>'&pressure='<?php echo $weather['barometer_units'];?>'&wind='<?php echo $weather['wind_units'];?>'&rain='<?php echo $weather['rain_units']?>" data-lity > <?php echo '| Feels';?> </a></span>
...
<a alt="weekly wind chill" title="weekly winchill" href="<?php echo $chartsource;?>/<?php echo $theme1;?>-charts.html?chart='windchillplot'&span='weekly'&temp='<?php echo $weather['temp_units'];?>'&pressure='<?php echo $weather['barometer_units'];?>'&wind='<?php echo $weather['wind_units'];?>'&rain='<?php echo $weather['rain_units']?>" data-lity > <?php echo '| Feels';?> </a></span>
...
if ($position12=='weather34uvsolar.php') {echo ' <span class="yearpopup"><a alt="UV Guide" title="UV Guide" href="uvindexwu.php" data-lity>'. $chartinfo. " UV Info </a></span>";}
if ($position12=='weather34uvsolar.php') {echo '<span class="yearpopup"> <a alt="Solar Alamanac" title="Solar Alamanac" href="solaralmanac.php" data-lity>'. $chartinfo. " Alamanac Solar </a></span>";}
if ($position12=='weather34uvsolar.php') {echo ' <span class="yearpopup"><a alt="UV Alamanac" title="UV Alamanac" href="uvalmanac.php" data-lity>&nbsp;'. $chartinfo. " | UV </a></span>";}





if ($position12=='solaruvds.php') {echo ' <span class="yearpopup"><a alt="UV Guide" title="UV Info" href="uvindexds.php" data-lity>'. $chartinfo. " UV Info </a></span>";}
...
<span class="todaypopup"> <a alt="yearly solar uv" title="yearly solar uv" href="<?php echo $chartsource;?>/<?php echo $theme1;?>-charts.html?chart='raduvplot'&span='yearly'&temp='<?php echo $weather['temp_units'];?>'&pressure='<?php echo $weather['barometer_units'];?>'&wind='<?php echo $weather['wind_units'];?>'&rain='<?php echo $weather['rain_units']?>" data-lity ><?php echo $menucharticonpage?> Solar/UV Year </a></span>
<a alt="weekly solar uv" title="weekly solar uv" href="<?php echo $chartsource;?>/<?php echo $theme1;?>-charts.html?chart='raduvplot'&span='weekly'&temp='<?php echo $weather['temp_units'];?>'&pressure='<?php echo $weather['barometer_units'];?>'&wind='<?php echo $weather['wind_units'];?>'&rain='<?php echo $weather['rain_units']?>" data-lity > <?php echo '| Week';?> </a></span>
...
<span class="todaypopup"> <a alt="weekly greenhouse" title="weekly greenhouse" href="<?php echo $chartsource;?>/<?php echo $theme1;?>-charts.html?chart='indoorplot'&span='weekly'&temp='<?php echo $weather['temp_units'];?>'&pressure='<?php echo $weather['barometer_units'];?>'&wind='<?php echo $weather['wind_units'];?>'&rain='<?php echo $weather['rain_units']?>" data-lity ><?php echo $menucharticonpage?> Greenhouse</a></span>
